...
sentence6 = QLabel('C++')
sentence1.setStyleSheet("font-size: 18px; color: blue;")  # Ubah ukuran font menjadi 18px
sentence2.setStyleSheet("font-size: 18px; color: red")
sentence3.setStyleSheet("font-size: 18px; color: orange")
sentence4.setStyleSheet("font-size: 18px; color: purple")
sentence5.setStyleSheet("font-size: 18px; color: lime")
sentence6.setStyleSheet("font-size: 18px; color: violet")
